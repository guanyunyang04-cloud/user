...
def build_parser() -> argparse.ArgumentParser:
    ...
    bootstrap = sub.add_parser("bootstrap", help="Resolve a main-brain-first bootstrap order.")
    bootstrap.add_argument("--brain", default="workspace")
    bootstrap.add_argument("--json", action="store_true")
    bootstrap.add_argument("--write-output", action="store_true")

    route = sub.add_parser("route", help="Route a task from the main brain to a workspace or child brain.")
