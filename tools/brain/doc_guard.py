...
from tools.brain.platform import build_brain_catalog, read_text as platform_read_text
from tools.brain.integrity_check import run_checks as run_brain_integrity_checks
...
DOC_RULES = {
    ...
    "brain/state_center.md": DocRule(
        warn_lines=120,
        max_lines=180,
        forbidden_heading_patterns=(
            (r"^##\s+20\d{2}-\d{2}-\d{2}\b", "main state center should stay a current routing document instead of becoming a dated log"),
        ),
    ),
    ...
    "brain/workflows/registry.json": DocRule(
        warn_lines=220,
        max_lines=320,
    ),
    "brain/workflows/playbooks/core.json": DocRule(
        warn_lines=220,
        max_lines=320,
    ),
...
ALLOWED_EXTERNAL_DOCS = {
    ...
    "quant_data_platform/DATA_BASE.md",
    "traditional_quant_research/README.md",
    "tools/archive_repair/README.md",
...
REQUIRED_DOC_SNIPPETS = {
    ...
    "daily_research/brain/operations_center.md": (
        ...
        "## Writeback Routes",
        "tools.brain.workflow capsule",
        "active_execution_strategy.json",
    ),
    "daily_research/brain/continuous_policy_design_contract.md": (
