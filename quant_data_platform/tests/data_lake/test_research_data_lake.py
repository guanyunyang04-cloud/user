...
from quant_data_platform.lake import ResearchDataLake, build_label_completeness_summary
from quant_data_platform.lake import build_pool_view
from quant_data_platform.lake import build_sector_board_view
from quant_data_platform.lake import build_research_database
from quant_data_platform.lake.pool_views import PoolViewSpec, build_pool_view_from_policy_bundle, load_pool_view
from quant_data_platform.lake.sector_board_views import (
    SectorBoardViewSpec,
    build_sector_board_view_from_policy_bundle,
    load_sector_board_view,
)
from quant_data_platform.lake.import_legacy_training_caches import import_legacy_training_dataset_caches
from quant_data_platform.lake.policy_input_loader import load_policy_inputs_from_lake
from quant_data_platform.lake.policy_input_audit import audit_policy_input_bundle
...
class ResearchDataLakeTest(unittest.TestCase):
    ...
    def test_policy_input_loader_pushes_symbol_filters_to_market_read(self) -> None:
        ...
        with TemporaryDirectory() as temp_dir:
            ...
            from quant_data_platform.lake import policy_input_loader as loader_module
    ...
    def test_build_pool_view_cli_blocks_when_active_artifact_has_diff(self) -> None:
        with mock.patch("quant_data_platform.lake.build_pool_view._active_artifact_has_diff", return_value=True):
    ...
    def test_sector_board_view_cli_blocks_active_artifact_diff(self) -> None:
        with mock.patch("quant_data_platform.lake.build_sector_board_view._active_artifact_has_diff", return_value=True):
            with self.assertRaisesRegex(ValueError, "active_artifact_diff_blocker"):
