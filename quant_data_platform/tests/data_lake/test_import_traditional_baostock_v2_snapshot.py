...
from quant_data_platform.lake.import_traditional_baostock_v2_snapshot import (
...
def test_import_traditional_baostock_v2_snapshot_cli_blocks_active_artifact_diff() -> None:
    with mock.patch(
        "quant_data_platform.lake.import_traditional_baostock_v2_snapshot._active_artifact_has_diff",
        return_value=True,
    ):
