...
from quant_data_platform.lake.build_v2_status_sidecar import main as sidecar_main
from quant_data_platform.lake.v2_status_sidecar import _read_domain_dataset, build_v2_status_sidecar, build_v2_status_sidecar_frame, is_mainboard_symbol
...
def test_build_v2_status_sidecar_cli_blocks_active_artifact_diff() -> None:
    with mock.patch("quant_data_platform.lake.build_v2_status_sidecar._active_artifact_has_diff", return_value=True):
