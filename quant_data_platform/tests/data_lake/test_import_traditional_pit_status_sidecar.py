...
from quant_data_platform.lake.import_traditional_pit_status_sidecar import (
...
def test_import_traditional_pit_status_sidecar_cli_blocks_active_artifact_diff() -> None:
    with mock.patch(
        "quant_data_platform.lake.import_traditional_pit_status_sidecar._active_artifact_has_diff",
        return_value=True,
    ):
