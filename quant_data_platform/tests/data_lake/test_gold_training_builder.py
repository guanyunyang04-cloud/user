...
from quant_data_platform.lake.audit_gold_dataset import audit_gold_dataset
from quant_data_platform.lake.gold_training_builder import (
    GoldBuildSpec,
    build_sharded_gold_training_dataset,
)
from quant_data_platform.lake import build_gold_training_dataset
...
class GoldTrainingBuilderTest(unittest.TestCase):
    ...
    def test_sharded_gold_builder_preserves_portfolio_state_and_registers_strict_dataset(self) -> None:
        ...
        with TemporaryDirectory() as temp_dir, patch(
            "quant_data_platform.lake.gold_training_builder._build_day_training_rows",
