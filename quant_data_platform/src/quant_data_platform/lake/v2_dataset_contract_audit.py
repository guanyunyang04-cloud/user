...
from quant_data_platform.lake.v2_status_sidecar import build_v2_status_sidecar_frame, summarize_v2_status_sidecar
...
DEFAULT_OUTPUT_ROOT = PROJECT_ROOT / "quant_data_platform/data/audits" / DEFAULT_RUN_TAG
