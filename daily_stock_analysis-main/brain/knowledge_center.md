...
- 公开 README 可保留用户安装、配置、演示与免责声明，但 AI 接管、结构边界和稳定规则必须先沉淀在 brain
- `AGENTS.md`、`CLAUDE.md`、`.github/copilot-instructions.md`、`.github/instructions/*.instructions.md`、`SKILL.md` 与 `strategies/README.md` 均属于兼容或公开说明入口；稳定规则、目录边界、验证矩阵和策略体系边界必须先沉淀在 brain
...
- 如果 AI 协作资产继续声明自己是唯一真源，而 brain 只保留摘要，后续 agent 会在 `brain-first` 和仓库原生入口之间反复摇摆；正确关系是 brain 为接管真源，仓库原生文档为兼容入口
