...
from daily_research.data_lake.v2_dataset_contract_audit import (
...
def test_v2_contract_audit_cli_blocks_active_artifact_diff() -> None:
    with mock.patch("daily_research.data_lake.v2_dataset_contract_audit._active_artifact_has_diff", return_value=True):
