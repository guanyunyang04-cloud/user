...
DECODER_PROFILES: dict[str, dict[str, float]] = {
    ...
    "holdcash_v3": {
        ...
        "candidate_defensive_penalty": 1.8,
        "turnover_defensive_penalty": 0.22,
        "position_cap_defensive_penalty": 0.02,
        "hold_bias_bonus": 0.14,
        "hold_override_margin": 0.05,
        "reduce_gate_bonus": 0.09,
        "open_gate_bonus": 0.018,
        "reentry_penalty": 0.08,
        "hold_delta_bonus": 0.020,
        "reduce_delta_softener": 0.18,
        "reduce_bias_bonus": 0.02,
        "exit_patience_bonus": 0.01,
        "reversal_cooldown_bonus": 0.05,
        "risk_off_open_penalty": 0.015,
    },
    "holdcash_v5": {
