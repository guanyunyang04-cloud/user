...
REQUIRED_DOC_SNIPPETS = {
    ...
    "daily_research/brain/state_center.md": (
        ...
        "supports_portfolio_source_release_heads",
        "supports_portfolio_listwise_heads",
    ...
    "daily_research/brain/operations_center.md": (
        ...
        "split_heads_direct_action_value_r14",
        "split_heads_direct_action_translation_r15",
        "cash_constraint_direct_action_guard_v8",
        "cash_constraint_direct_action_reallocation_guard_v9",
        "cash_constraint_direct_action_pair_reallocation_guard_v10",
        "cash_constraint_direct_action_pair_cost_guard_v11",
        "cash_constraint_portfolio_daily_ranking_guard_v12",
        "cash_constraint_portfolio_daily_ranking_cash_aware_guard_v13",
        "cash_constraint_portfolio_daily_ranking_source_exec_guard_v14",
        "cash_constraint_portfolio_daily_ranking_receiver_exec_guard_v15",
        "portfolio_daily_ranking_v2_gated",
        ...
        "portfolio_daily_source_release_capacity",
        "portfolio_daily_source_executability",
        "portfolio_daily_listwise_audit.py",
        "monthly_returns.csv",
