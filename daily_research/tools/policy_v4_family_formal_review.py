...
DEFAULT_ROOT_TAG = "short_alpha_policy_v4_family_formal_review_20260411_r1"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run a narrow formal family review for policy_v4a / policy_v4b against the current mainline."
    )
...
def main() -> None:
    ...
    lines = [
        "# Policy V4 Family Formal Review",
        "",
        "## Scope",
        ...
        "- compared family: `short_expert_policy_v4a`, `short_expert_policy_v4b`",
        "",
        "## Direct Answer",
    ...
    lines.extend(
        [
            ...
            "",
            "## Decision",
            "- Only a family candidate that preserves the learned-control direction while improving formal stability should move on to constrained execution review.",
        ]
    )
