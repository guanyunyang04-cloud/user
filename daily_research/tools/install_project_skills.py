...
PROJECT_SKILLS_ROOT = WORKSPACE_ROOT / "daily_research/brain/skills"
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Sync repo-canonical daily_research project skills into the Codex skills directory.")
