...
TASK_SPECS: tuple[ExecutionTaskSpec, ...] = (
    ...
    ExecutionTaskSpec(
        ...
        script_relative_path="quant_data_platform/src/quant_data_platform/qdp_v2/update.py",
        description="直接更新当前 QDP：BaoStock 低频主源、mootdx 5m 加速、BaoStock 5m 补缺。",
        category="data_platform",
        timeout_seconds=7200,
        safety_level="caution",
        safety_summary="只更新 QDP 当前通用数据表，不触发训练、回测或 execution promotion。",
    ),
    ExecutionTaskSpec(
        name="provider-health-check",
        script_relative_path="quant_data_platform/src/quant_data_platform/provider_health.py",
        description="只读检查 BaoStock/mootdx 的当前 QDP provider/domain 能力。",
        category="data_platform",
        timeout_seconds=1800,
        safety_level="safe",
