    ...
    ExecutionTaskSpec(
        ...
        form_fields=(
            ...
            TaskFieldSpec(
                ...
                choices=("balanced_v2", "swing_v2", "defensive_v2"),
            ...
            TaskFieldSpec(
                ...
                choices=("formal_torch_v2", "prototype_gbdt_v1"),
                help_text="formal_torch_v2 支持 GPU/32epoch/strict resume；prototype_gbdt_v1 仅限 shadow 原型。",
                section="selection",
            ),
            TaskFieldSpec(
            ...
            TaskFieldSpec(
                ...
                arg_flag="--epochs",
                default_value="32",
                help_text="formal_torch_v2 的初始正式预算至少 32 epoch。",
                section="runtime",
            ),
            TaskFieldSpec(
                name="resume_mode",
    ...
    ExecutionTaskSpec(
        ...
        form_fields=(
            ...
            TaskFieldSpec(
                ...
                default_value="formal_torch_v2",
                choices=("formal_torch_v2", "prototype_gbdt_v1"),
                help_text="formal_torch_v2 是可 promotion 的正式候选；prototype_gbdt_v1 只做 shadow/teacher。",
                section="selection",
            ),
            TaskFieldSpec(
                name="start_date",
            ...
            TaskFieldSpec(
                ...
                arg_flag="--epochs",
                default_value="32",
                help_text="formal_torch_v2 的正式训练预算；首次正式训练至少 32 epoch。",
                section="runtime",
            ),
            TaskFieldSpec(
                name="resume_mode",
