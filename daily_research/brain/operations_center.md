...
## 2026-04-27 r25 P0/P1 执行命令与产物
- P0 strict-resume 命令：`C:/Users/ASUS/miniconda3/envs/yolos/python.exe daily_research/continuous_policy/run_self_optimizing_study.py --search-profile split_heads_portfolio_daily_source_release_listwise_r25 --study-tag cp_v3_portfolio_daily_source_release_listwise_r25_confirmfix_release_quality6_20260427 --trial-count 1 --confirmatory-max-candidates 1 --epochs 24 --min-epochs 18 --confirmatory-epochs 26 --confirmatory-min-epochs 20 --trainer-backend formal_torch_seq_v3 --resume-mode strict`
- source observable guard 验证命令：`C:/Users/ASUS/miniconda3/envs/yolos/python.exe daily_research/continuous_policy/run_self_optimizing_study.py --search-profile split_heads_portfolio_daily_source_release_listwise_r25 --study-tag cp_v3_portfolio_daily_source_release_listwise_r25_release_quality_guarded_20260427 --trial-count 1 --confirmatory-max-candidates 1 --epochs 24 --min-epochs 18 --confirmatory-epochs 26 --confirmatory-min-epochs 20 --trainer-backend formal_torch_seq_v3 --resume-mode fresh`
- receiver/source 双守门短验证命令：`C:/Users/ASUS/miniconda3/envs/yolos/python.exe daily_research/continuous_policy/run_self_optimizing_study.py --search-profile split_heads_portfolio_daily_source_release_listwise_r25 --study-tag cp_v3_portfolio_daily_source_release_listwise_r25_release_receiver_guarded_v2_smoke_20260427 --trial-count 1 --confirmatory-max-candidates 1 --epochs 8 --min-epochs 4 --confirmatory-epochs 10 --confirmatory-min-epochs 5 --trainer-backend formal_torch_seq_v3 --resume-mode fresh`
- v2 smoke 审计产物：`daily_research/output/continuous_policy/studies/cp_v3_portfolio_daily_source_release_listwise_r25_release_receiver_guarded_v2_smoke_20260427/listwise_audit_trial_01/portfolio_daily_listwise_audit_summary.json` 与 `daily_research/output/continuous_policy/studies/cp_v3_portfolio_daily_source_release_listwise_r25_release_receiver_guarded_v2_smoke_20260427/listwise_audit_confirm_01/portfolio_daily_listwise_audit_summary.json`
- 后续若继续推进，不应先扩 P1 参数搜索；必须先让 v2 双守门在 `24/26` 或更长预算下保持 `receiver_unrealized_deploy_share = 0`，否则参数搜索会把执行层假信号当成策略优劣。

## 2026-04-28 r25 v3 长预算命令与产物
- v2 长预算复核命令：`C:/Users/ASUS/miniconda3/envs/yolos/python.exe daily_research/continuous_policy/run_self_optimizing_study.py --search-profile split_heads_portfolio_daily_source_release_listwise_r25 --study-tag cp_v3_portfolio_daily_source_release_listwise_r25_release_receiver_guarded_v2_long_20260428 --trial-count 1 --confirmatory-max-candidates 1 --epochs 24 --min-epochs 18 --confirmatory-epochs 26 --confirmatory-min-epochs 20 --trainer-backend formal_torch_seq_v3 --resume-mode fresh`
- v3 smoke 命令：`C:/Users/ASUS/miniconda3/envs/yolos/python.exe daily_research/continuous_policy/run_self_optimizing_study.py --search-profile split_heads_portfolio_daily_source_release_listwise_r25 --study-tag cp_v3_portfolio_daily_source_release_listwise_r25_release_receiver_guarded_v3_smoke_20260428 --trial-count 1 --confirmatory-max-candidates 1 --epochs 8 --min-epochs 4 --confirmatory-epochs 10 --confirmatory-min-epochs 5 --trainer-backend formal_torch_seq_v3 --resume-mode fresh`
- v3 长预算命令：`C:/Users/ASUS/miniconda3/envs/yolos/python.exe daily_research/continuous_policy/run_self_optimizing_study.py --search-profile split_heads_portfolio_daily_source_release_listwise_r25 --study-tag cp_v3_portfolio_daily_source_release_listwise_r25_release_receiver_guarded_v3_long_20260428 --trial-count 1 --confirmatory-max-candidates 1 --epochs 24 --min-epochs 18 --confirmatory-epochs 26 --confirmatory-min-epochs 20 --trainer-backend formal_torch_seq_v3 --resume-mode fresh`
- v3 长预算 study summary：`daily_research/output/continuous_policy/studies/cp_v3_portfolio_daily_source_release_listwise_r25_release_receiver_guarded_v3_long_20260428/study_summary.json`
- v3 长预算审计产物：`daily_research/output/continuous_policy/studies/cp_v3_portfolio_daily_source_release_listwise_r25_release_receiver_guarded_v3_long_20260428/listwise_audit_trial_01/portfolio_daily_listwise_audit_summary.json` 与 `daily_research/output/continuous_policy/studies/cp_v3_portfolio_daily_source_release_listwise_r25_release_receiver_guarded_v3_long_20260428/listwise_audit_confirm_01/portfolio_daily_listwise_audit_summary.json`
- 操作结论：v3 解决 receiver unrealized 的长预算污染，但确认 r25 当前组合日分配分支失活；后续若继续 r25，不得只看语义干净，必须先恢复非零 receiver/source/cash 的经济闭环。

## 2026-04-28 r26 allocation-teacher 命令与产物
- r26 dry-run 命令：`C:/Users/ASUS/miniconda3/envs/yolos/python.exe daily_research/continuous_policy/run_self_optimizing_study.py --search-profile split_heads_portfolio_daily_allocation_teacher_r26 --study-tag verify_r26_allocation_teacher_profile_20260428 --trial-count 1 --confirmatory-max-candidates 1 --epochs 8 --min-epochs 4 --confirmatory-epochs 10 --confirmatory-min-epochs 5 --trainer-backend formal_torch_seq_v3 --resume-mode fresh --dry-run`；smoke4 命令同参数去掉 `--dry-run`，tag 为 `cp_v3_portfolio_daily_allocation_teacher_r26_smoke4_20260428`。
- r26 smoke4 产物：`daily_research/output/continuous_policy/studies/cp_v3_portfolio_daily_allocation_teacher_r26_smoke4_20260428/study_summary.json` 与 `daily_research/output/continuous_policy/models/cp_v3_portfolio_daily_allocation_teacher_r26_smoke4_20260428__confirm_01__train/training_diagnostics.json`。
- protected source 审计重评估 tag：`cp_v3_portfolio_daily_allocation_teacher_r26_protected_source_audit_eval4_20260428`；summary：`daily_research/output/continuous_policy/evaluations/cp_v3_portfolio_daily_allocation_teacher_r26_protected_source_audit_eval4_20260428/evaluation_summary.json`。
- 操作纪律：r26 后续不得用 simulator protected-source override 直接制造 source sell；`portfolio_daily_source_protected_release_override_count` 只能作为审计候选，不是授权卖出信号。继续推进必须让 label/listwise teacher 学会正 receiver-source spread、非零 source sell、正收益与月度质量同时成立。
