...
- P2：围绕 r71 multi-stage regret 继续验证 receiver/deploy 平衡、cash timing、drawdown/reversal、source quality 与 sufficient training evidence；translation closure 和 oracle feasibility 不再是当前主 blocker。
