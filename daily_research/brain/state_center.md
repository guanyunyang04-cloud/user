...
- 当前有效 continuous_policy 研究基线仍是 r39 allocation objective consolidation；r40-r69 均为 research / shadow 升级链或基础设施证据。
...
- P2：围绕 r69 value arbitration 继续修 receiver/deploy 平衡、oracle constraint violation、cash timing、drawdown/reversal 与 sufficient training evidence；translation closure 不再是当前主 blocker。
...
- r50-r69 详细证据：`daily_research/brain/references/r*_*.md`。
