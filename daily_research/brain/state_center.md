...
- 当前有效 continuous_policy 研究基线仍是 r39 allocation objective consolidation；r40-r68 均为 research / shadow 升级链或基础设施证据。
...
- P2：围绕 r68 DFL-PG v1 继续修 source selection quality、cash timing、drawdown/reversal 与 sufficient training evidence；translation closure 不再是当前主 blocker。
...
- r50-r68 详细证据：`daily_research/brain/references/r*_*.md`。
