...
- r69 后续策略研究应优先修 receiver/deploy 平衡、oracle constraint violation、cash timing、drawdown/reversal 与 sufficient training evidence；不得从 train-only mechanism evidence 直接进入 promotion。
